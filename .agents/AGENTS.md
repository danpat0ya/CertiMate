...
1. **DB 연결 확인**:
   - `C:\Users\you03\IntelliJ-workspace\certimate\src\main\resources\application.yml`의 DB 접속 정보가 외부 DB 서버(`3.39.237.132:3306/CertiMate`)로 올바르게 설정되어 있는지 확인하고, 아니라면 수정합니다.
